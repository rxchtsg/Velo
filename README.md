...
## What is this?
I moved to Germany and found that not speaking fluent German creates constant friction- calling the doctor, dealing with landlords, sitting through university events that switch mid sentence. It adds up fast.

Velo is my attempt to reduce that friction. You speak in English, the person on the other end hears German, and vice versa9 as close to real time as possible.
...
Speech-to-text	OpenAI Whisper	Best accuracy tested, handles background noise well
Translation	DeepL	More natural output than Google Translate for German/English
Text-to-speech	gTTS	Free, functional for a demo — robotic but adequate
...
Open 
http://localhost:5000
. You need an OpenAI key for Whisper and a DeepL key for translation.
